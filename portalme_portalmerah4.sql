...
-- Dumping data for table portalme_portalmerah.tblartikel: ~11 rows (approximately)
...
INSERT INTO `tblartikel` (`id_artikel`, `link`, `news_judul`, `news_konten`, `news_gambar`, `news_video`, `news_traffic`, `news_status`, `created_at`, `updated_at`) VALUES
	...
	(19, 'Update-Baru', 'Update Baru EDITDD', '<p>UPDATE BARU</p>', 'assets/berita/images/Screenshot 2022-07-29 024722.png', '', 1, 1, '2022-07-28 14:47:46', '2022-07-30 13:27:09'),
	(20, 'COBA-1', 'EDIT COBA 123', '<p>EDIT COBA 1123</p>', 'assets/berita/images/Screenshot 2022-07-31 000840.png', '', 0, 0, '2022-07-30 12:07:30', '2022-07-30 12:08:59');
...
-- Dumping data for table portalme_portalmerah.tblberita: ~11 rows (approximately)
...
INSERT INTO `tblkomen` (`id_komen`, `id_artikel`, `komen_isi`, `komen_user`, `komen_email`, `komen_status`, `created_at`, `updated_at`) VALUES
	(3, 11, 'dsf', 'fds', 'fdskjh@dsgak.coom', 1, '2022-07-04 19:57:42', '2022-07-28 14:46:49'),
	(4, 11, 'dafjkd', 'jdkshaf', 'sdfhk@gmail.cim', 1, '2022-07-04 19:59:41', '2022-07-28 14:46:46');
...
-- Dumping data for table portalme_portalmerah.tblnewstraffic: ~1 rows (approximately)
...
INSERT INTO `users` (`id`, `email`, `username`, `fullname`, `image`, `about`, `password_hash`, `reset_hash`, `reset_at`, `reset_expires`, `activate_hash`, `status`, `status_message`, `active`, `force_pass_reset`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(21, 'junaedi171100@gmail.com', 'xxx', NULL, NULL, NULL, '$2y$10$gv.Q9V.kzZyXjZCnDOSGfO7se/iEsRax5RhH25uJkI0IQPhRu6C6q', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2022-08-01 01:42:08', '2022-08-01 01:43:40', NULL);
